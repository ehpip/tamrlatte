        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 animate-fadeIn">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-amber-900 leading-tight mb-4">
              Tamrlatte -{" "}
              <span className="text-amber-600">A Sip of Homemade Comfort</span>
            </h1>
            <p className="text-xl text-amber-800 mb-8 max-w-lg">
              TamrLatte combines premium Sukkari dates, creamy full cream milk,
              and rich palm sugar to create a naturally sweet, nutrient-rich
              beverage that delights your taste buds and nourishes your body —
              all made with love from our home to yours.
            </p>
